...
foreach (string name in studentNames)
{
    ...
    // initalize/reset the calculated average of exam + extra credit scores
    decimal currentStudentGrade = 0;

    // iniitialize/reset a counter for the number of assignments
    int gradedAssignments = 0;

    // loop through the scores array and complete calculations for current Student
